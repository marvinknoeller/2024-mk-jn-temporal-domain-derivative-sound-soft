...
for it = 1 : 5
    rads = 1;
    save_results = 1;
    name = strcat("PaperD1_",num2str(it));
    ...
    uincp = planewaveRK(signal,signalp,dir,Var.Tlag,gp.midpt,gp.normal,Var.T,Var.M,1,c)...
        + planewaveRK(signal,signalp,-dir,Var.Tlag,gp.midpt,gp.normal,Var.T,Var.M,1,c);
    uincm = planewaveRK(signal,signalp,dir,Var.Tlag,gm.midpt,gm.normal,Var.T,Var.M,1,c)...
        +planewaveRK(signal,signalp,-dir,Var.Tlag,gm.midpt,gm.normal,Var.T,Var.M,1,c);
    ...
    uscat = direct_sound_soft_splineRK(Var,Geometry,video,'direct_vid_double'); fprintf("Direct problem: Done. \n")
    ...
    while j < 5000
        ...
        if golden_section == 1
            ...
            uincp = planewaveRK(signal,signalp,dir,Var.Tlag,gpX2.midpt,gpX2.normal,Var.T,Var.M,1,c)...
                +planewaveRK(signal,signalp,-dir,Var.Tlag,gpX2.midpt,gpX2.normal,Var.T,Var.M,1,c);
            uincm = planewaveRK(signal,signalp,dir,Var.Tlag,gmX2.midpt,gmX2.normal,Var.T,Var.M,1,c)...
                +planewaveRK(signal,signalp,-dir,Var.Tlag,gmX2.midpt,gmX2.normal,Var.T,Var.M,1,c);
            beta0 = (Pp*uincp+Pm*uincm);
            Geometry.ps = psX2;
            Geometry.mindist = minimaldistance(Var,Geometry);
            Geometry.beta0 = beta0;
            ...
            uincp = planewaveRK(signal,signalp,dir,Var.Tlag,gpX3.midpt,gpX3.normal,Var.T,Var.M,1,c)...
                +planewaveRK(signal,signalp,-dir,Var.Tlag,gpX3.midpt,gpX3.normal,Var.T,Var.M,1,c);
            uincm = planewaveRK(signal,signalp,dir,Var.Tlag,gmX3.midpt,gmX3.normal,Var.T,Var.M,1,c)...
                +planewaveRK(signal,signalp,-dir,Var.Tlag,gmX3.midpt,gmX3.normal,Var.T,Var.M,1,c);
            beta0 = (Pp*uincp+Pm*uincm);
            Geometry.ps = psX3;
            Geometry.mindist = minimaldistance(Var,Geometry);
            Geometry.beta0 = beta0;
            ...
            for kk = 1:numsplits
                ...
                uincp = planewaveRK(signal,signalp,dir,Var.Tlag,gpXnew.midpt,gpXnew.normal,Var.T,Var.M,1,c)...
                    +planewaveRK(signal,signalp,-dir,Var.Tlag,gpXnew.midpt,gpXnew.normal,Var.T,Var.M,1,c);
                uincm = planewaveRK(signal,signalp,dir,Var.Tlag,gmXnew.midpt,gmXnew.normal,Var.T,Var.M,1,c)...
                    +planewaveRK(signal,signalp,-dir,Var.Tlag,gmXnew.midpt,gmXnew.normal,Var.T,Var.M,1,c);
                beta0 = (Pp*uincp+Pm*uincm);
                Geometry.ps = psXnew;
                Geometry.mindist = minimaldistance(Var,Geometry);
                Geometry.beta0 = beta0;
...
plot_pictures = 1;
if plot_pictures
    load('Paper1/PaperD1_1.mat')
    PlotIterates(vals,ssvec,Geometry.observationpoints,[1,3,6,10,11,size(ssvec,3)],'Rec1Double_');
end
