...
for it = 1 : 5
    rads = 0.5;
    save_results = 1;
    name = strcat("Paper22_4Pts_",num2str(it));
    ...
    startobs = pi;
    endobs =   7/4*pi;
    tobs = linspace(startobs,endobs,nobs);
    radius = 6;
...
plot_pictures = 1;
if plot_pictures
    load('Paper2/Paper22_4Pts_1.mat')
    PlotIterates(vals,ssvec,Geometry.observationpoints,[1,3,6,11,16,size(ssvec,3)],'Ex2_');
end